...
Notice that on each of the above photos with an accompanying stamp, the stamp is cancelled with matching name and handwriting, and the year "1866" is clearly written on each:
